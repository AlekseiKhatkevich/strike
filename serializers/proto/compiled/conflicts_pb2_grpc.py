...
class ConflictsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UpdateConflict = channel.unary_unary(
                '/strike.ConflictsService/UpdateConflict',
                request_serializer=conflicts__pb2.Conflict.SerializeToString,
                response_deserializer=conflicts__pb2.SingleConflictResponse.FromString,
                )
        self.ListConflicts = channel.unary_unary(
                '/strike.ConflictsService/ListConflicts',
                request_serializer=conflicts__pb2.MultipleConflictsRequest.SerializeToString,
                response_deserializer=conflicts__pb2.MultipleConflictsResponse.FromString,
                )
...
class ConflictsServiceServicer(object):
    ...
    def UpdateConflict(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_ConflictsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UpdateConflict': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateConflict,
                    request_deserializer=conflicts__pb2.Conflict.FromString,
                    response_serializer=conflicts__pb2.SingleConflictResponse.SerializeToString,
            ),
            'ListConflicts': grpc.unary_unary_rpc_method_handler(
                    servicer.ListConflicts,
                    request_deserializer=conflicts__pb2.MultipleConflictsRequest.FromString,
                    response_serializer=conflicts__pb2.MultipleConflictsResponse.SerializeToString,
            ),
    }
...
class ConflictsService(object):
    ...
    def UpdateConflict(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/strike.ConflictsService/UpdateConflict',
            conflicts__pb2.Conflict.SerializeToString,
            conflicts__pb2.SingleConflictResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ListConflicts(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/strike.ConflictsService/ListConflicts',
            conflicts__pb2.MultipleConflictsRequest.SerializeToString,
            conflicts__pb2.MultipleConflictsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
