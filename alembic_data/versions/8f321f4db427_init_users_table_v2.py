...
Revision ID: 8f321f4db427
Revises: 
Create Date: 2023-05-31 10:18:45.153902
...
def upgrade() -> None:
    ...
    sa.CheckConstraint("regexp_like(hashed_password, '^\\$2[aby]?\\$\\d{1,2}\\$[.\\/A-Za-z0-9]{53}$')", name=op.f('ck_users_hashed_password')),
